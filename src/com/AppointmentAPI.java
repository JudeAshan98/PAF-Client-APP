...
//	private static final long serialVersionUID = 1L;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String output = appObj.insertAppoinment(request.getParameter("date"), request.getParameter("time"),
				request.getParameter("hospitalID"), request.getParameter("patientID"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		...
		String output = appObj.updateAppoinment(paras.get("AppointmentID").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response)
		...
		// TODO Auto-generated method stub
		Map paras = getParasMap(request);
		String output = appObj.DeleteAppoinment(paras.get("AppointmentID").toString());
		response.getWriter().write(output);
	}
